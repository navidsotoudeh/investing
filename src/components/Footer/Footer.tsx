...
const Footer = () => {
	return (
		<footer className="flex h-[100px] w-full justify-between bg-[#e0e0e0] p-4 pb-8 " dir="rtl">
			<div>
				<div className="flex ">
				...
				<Text>تهران، خیابان شهید بهشتی، بین بخارست و وزرا، ساختمان میکرواینوستینگ ، تلفن: 24328008-021</Text>
			</div>
